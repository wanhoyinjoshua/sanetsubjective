...
export const  data = [
  new Document({
    ...
    pageContent: "MAry is living alone in the house.",
  }),
  new Document({
    metadata: { id: 2,category:"home environment" },
    pageContent: "there are steps to the front entrace of Mary's house",
  }),
  new Document({
      metadata: { id: 3,category:"home environment" },
      pageContent: "there are four steps to the front entrace of Mary's house",
    }),
    new Document({
  ...
  new Document({
    ...
    pageContent: "I am living with my son Tom,my son is 30 years old, but I find it hard to rest when Tom is at home as he is so restless and fidgety",
    }),
